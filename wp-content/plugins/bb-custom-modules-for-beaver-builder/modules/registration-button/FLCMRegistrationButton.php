...
/**
 * @class FLCMRegistrationButton
 */
class FLCMRegistrationButton extends FLBuilderModule{
	...
	public function __construct(){
		parent::__construct([
			'name' => __('Registration Button', 'fl-builder'),
			'description' => __('A registration popup button.', 'fl-builder'),
 ...
 */
FLBuilder::register_module('FLCMRegistrationButton', [
	'general' => [
			...
			'general' => [
				...
				'fields' => [
					'text' => [
						...
						'default' => __('SIGN UP NOW', 'fl-builder'),
						'preview' => [
							'type' => 'text',
					...
					'css_class' => [
						'type' => 'text',
						'default' => 'register_popup registerbutton',
