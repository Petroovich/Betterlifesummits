...
class Core{
	...
	private static $slug = "b3_settings";
	...
	public static function load_textdomain(){
		load_plugin_textdomain(B3_TD, false, B3_PLUGIN_DIR_SHORT.'/languages/');
	}
	...
	public static function create_tables(){
		...
		self::$sql_structure = include_once B3_PLUGIN_DIR."/inc/sql/structure.php";
